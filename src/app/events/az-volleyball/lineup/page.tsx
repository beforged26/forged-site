...
const coaches: { name: string; role: string; bio: string; website: string; photo?: string }[] = [
  ...
  },
  {
    ...
    role: "LOVB Coach of the Year — Head Coach, LOVB Houston — Former Arizona State University Head Coach — Former Serbian National Team",
